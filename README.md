...
## 制作背景
* 自分の趣味であるサイクリングに関して、淡路島やしまなみ海道などのメジャースポットの情報は専用のサイトなどがある一方、マイナーなスポットなどを紹介するサイトは個人のブログなどに限られており、情報が得にくかった<br>
* その反面、友人の体験談などを聞いて、自分そのサイクルスポットに興味を持つことがあり、サイクリングの体験談は、同じ趣味を持つ人に需要があるのではないかと考えた<br>
